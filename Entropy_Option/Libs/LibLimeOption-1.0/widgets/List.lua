...
LBO:RegisterWidget(widget, version, function(self, name)
	...
	self.scrollframe = CreateFrame("ScrollFrame", name.."Scroll", self, "ListScrollFrameTemplate")
	...
	for i = 1, 10 do
		...
		self.scrollframe.buttons[i]:GetFontString():SetMaxLines(1)
