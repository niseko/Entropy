local widget, version = "BasicTemplates", 3
...
function LBO:CreateDropDownMenu(name, strata)
	if _G["LibLimeOption10"..name.."Menu"] then
		return _G["LibLimeOption10"..name.."Menu"]
	else
		local menu = CreateFrame("Frame", "LibLimeOption10"..name.."Menu", UIParent)
