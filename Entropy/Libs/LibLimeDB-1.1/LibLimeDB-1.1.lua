local MAJOR_VERSION, MINOR_VERSION = "LibLimeDB-1.1", 5
...
if not InterfaceOptionsFrame.LibLimeOptionHandler then
	InterfaceOptionsFrame.LibLimeOptionHandler = CreateFrame("Frame", nil, InterfaceOptionsFrame)
	InterfaceOptionsFrame.LibLimeOptionHandler:SetScript("OnShow", function(self)
